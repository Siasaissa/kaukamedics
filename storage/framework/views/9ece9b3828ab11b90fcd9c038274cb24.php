                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a href="<?php echo e(route('products')); ?>" class="nav-link">Products</a></li>
                            <li class="nav-item active"><a href="<?php echo e(route('service')); ?>" class="nav-link">Services</a></li>
                            <li class="nav-item"><a href="<?php echo e(route('about')); ?>" class="nav-link">About Us</a></li>
...
</html><?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/service.blade.php ENDPATH**/ ?>