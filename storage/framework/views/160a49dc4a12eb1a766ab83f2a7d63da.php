...
<body>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="100" valign="top">
                    ...
                    ?>
                    <?php if($logoBase64): ?>
                        <img src="<?php echo e($logoBase64); ?>" alt="Logo" style="height: 100px; width: auto;">
                    <?php endif; ?>
                </td>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="60%" valign="top" style="font-size: 10px;">
                    ...
                    <p style="margin: 2px 0;"><strong><?php echo e($invoice->customer_name); ?></strong></p>
                    <p style="margin: 2px 0;"><?php echo e($invoice->customer_address); ?></p>
                    <p style="margin: 2px 0;"><?php echo e($invoice->customer_phone); ?></p>
                    <?php if($invoice->customer_email): ?>
                    <p style="margin: 2px 0;"><?php echo e($invoice->customer_email); ?></p>
                    <?php endif; ?>
                </td>

                <!-- Invoice Info -->
                <td valign="top" style="text-align: right;">
                    <h2 style="margin: 0; color: #f7941d; font-size: 16px;"><?php echo e($invoice->invoice_number); ?></h2>
                    <p style="margin: 2px 0; color: #f7941d; font-size: 10px;"><?php echo e($invoice->invoice_date->format('m-d-Y')); ?></p>
                    <?php if($invoice->reference): ?>
                    <p style="margin: 2px 0; font-size: 10px;">Ref. : <?php echo e($invoice->reference); ?></p>
                    <?php endif; ?>
                </td>
            </tr>
        </table>
    ...
    <table class="border" width="100%" cellpadding="5" cellspacing="0" style="border-collapse: collapse; font-size: 9px; margin-bottom: 10px;">
        ...
        <tbody>
            ...
            <tr>
                <td style="border: 1px solid #343232; padding: 5px; text-align: center; font-size: 9px;"><?php echo e($index + 1); ?></td>
                <td style="border: 1px solid #343232; padding: 5px; text-align: left; font-size: 9px;"><?php echo e($item->product); ?></td>
                <td style="border: 1px solid #343232; padding: 5px; text-align: center; font-size: 9px;"><?php echo e(number_format($item->qty, 2)); ?></td>
                <td style="border: 1px solid #343232; padding: 5px; text-align: right; font-size: 9px;"><?php echo e(number_format($item->rate, 2)); ?></td>
                <td style="border: 1px solid #343232; padding: 5px; text-align: right; font-size: 9px;"><?php echo e(number_format($item->amount, 2)); ?></td>
            </tr>
                        ...
                        <td style="border-top: 1px solid #f7941d; border-bottom: 1px solid #f7941d; padding: 0;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="padding: 6px 8px; text-align: right; font-size: 9px;"><strong>Sh <?php echo e(number_format($invoice->subtotal, 2)); ?></strong></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td style="border-bottom: 1px solid #f7941d; padding: 0;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="padding: 6px 8px; text-align: right; font-size: 9px;"><strong>Sh <?php echo e(number_format($invoice->shipping_charges, 2)); ?></strong></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td style="border-bottom: 1px solid #f7941d; background-color: #f7941d; color: white; padding: 0;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="padding: 6px 8px; text-align: right; font-size: 9px;"><strong>Sh <?php echo e(number_format($invoice->grand_total, 2)); ?></strong></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td style="padding: 0;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="padding: 6px 8px; text-align: right; font-size: 9px;"><strong>Sh <?php echo e(number_format($invoice->balance, 2)); ?></strong></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    <table width="100%" cellpadding="8" cellspacing="0" style="margin-top: 15px; border-collapse: collapse; font-size: 8px;">
        <tr>
            ...
            <td width="33%" valign="top" style="border: 1px solid #343232; padding: 10px;">
                ...
                <p style="margin: 8px 0 3px 0;"><strong>Invoice Date:</strong> <?php echo e($invoice->invoice_date->format('M d, Y')); ?></p>
                <p style="margin: 3px 0;"><strong>Due Date:</strong> <?php echo e($invoice->due_date->format('M d, Y')); ?></p>
                <?php if($invoice->status): ?>
                <p style="margin: 3px 0;"><strong>Status:</strong> <?php echo e(ucfirst($invoice->status)); ?></p>
                <?php endif; ?>
            </td>
        </tr>
    </table>
...
</html><?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/admin/invoice/pdf.blade.php ENDPATH**/ ?>