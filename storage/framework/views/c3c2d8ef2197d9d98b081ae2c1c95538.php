            ...
            <div class="col-lg-11">
                <div class="h-100 py-5 d-flex align-items-center">
                    <button type="button" class="btn-play" data-bs-toggle="modal"
                        data-src="<?php echo e(asset('img/video4.mp4')); ?>" data-bs-target="#videoModal">
                        <span></span>
                    </button>
            ...
            <div class="modal-body">
                <div class="ratio ratio-16x9">
                    <video id="video" class="w-100 rounded" controls autoplay muted>
                        <source src="<?php echo e(asset('img/video4.mp4')); ?>" type="video/mp4">
...
</html><?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/con.blade.php ENDPATH**/ ?>