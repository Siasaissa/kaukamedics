                ...
                <div class="col-lg-5">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div class="mb-4">
                        ...
                        <form action="<?php echo e(route('vcard.upload')); ?>" method="POST" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                      ...
                      <div class="mb-3">
                        ...
                        <form action="<?php echo e(route('vcard.upload')); ?>" method="POST">
                          <?php echo csrf_field(); ?>
                          <div class="row">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form action="<?php echo e(route('sms.send.bulk')); ?>" method="POST" id="smsForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div id="contactSelectionSection" class="d-none">
                          <div class="mb-3">
                            <p class="mb-2">Select Contacts <span class="badge bg-secondary"><?php echo e($total); ?></span></p>
                            ...
                            <div class="card">
                              <div class="card-header">
                                ...
                                <small class="text-muted">
                                  <span id="visibleContacts"><?php echo e(count($contacts)); ?></span> contacts shown
                                </small>
                              </div>
                              ...
                              <div class="card-body p-0" style="max-height: 250px; overflow-y: auto;">
                                <div id="contactsContainer">
                                  <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-3 border-bottom" data-contact-id="<?php echo e($contact->id); ?>" 
                                         data-name="<?php echo e(strtolower($contact->full_name)); ?>"
                                         data-phone="<?php echo e($contact->phone_number); ?>"
                                         data-email="<?php echo e(strtolower($contact->email)); ?>"
                                         data-company="<?php echo e(strtolower($contact->organization)); ?>">
                                      <div class="form-check mb-0">
                                        <input class="form-check-input contact-checkbox" type="checkbox" 
                                               name="selected_contacts[]" value="<?php echo e($contact->id); ?>" 
                                               id="contact_<?php echo e($contact->id); ?>" data-phone="<?php echo e($contact->phone_number); ?>">
                                        <label class="form-check-label d-flex justify-content-between align-items-center" for="contact_<?php echo e($contact->id); ?>">
                                          <div>
                                          ...
                                          <div class="text-end">
                                            <small class="badge bg-light text-dark">
                                              <?php echo e($contact->organization ?: 'No Company'); ?>
                          ...
                          <tbody>
                            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                <td>
                                  <div class="d-flex px-2 py-1">
                                    <div class="d-flex flex-column justify-content-center">
                                      <h6 class="mb-0 text-sm"><?php echo e($msg->id); ?></h6>
                                    </div>
                                  </div>
                                </td>
                                <td>
                                  <p class="text-sm font-weight-bold mb-0"><?php echo e($msg->receiver); ?></p>
                                </td>
                                <td>
                                  <p class="text-sm mb-0" title="<?php echo e($msg->message); ?>">
                                ...
                                <td>
                                  <span class="badge 
                                    <?php if($msg->status == 'Pending'): ?> bg-warning 
                                    <?php elseif($msg->status == 'Delivered'): ?> bg-success 
                                ...
                                <td>
                                  <p class="text-sm mb-0"><?php echo e($msg->created_at->format('d M Y H:i')); ?></p>
                                </td>
                              </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
...
</html><?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/bulk.blade.php ENDPATH**/ ?>