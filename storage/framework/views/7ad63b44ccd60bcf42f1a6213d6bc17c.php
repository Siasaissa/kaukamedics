...
<?php if(session('success') || session('error')): ?>
    <div id="alert-message"
        ...
        style="
            min-width: 320px;
            background-color: rgba(<?php echo e(session('success') ? '40,167,69' : '220,53,69'); ?>, 0.9);
            color: #fff;
        ...
        <div class="d-flex align-items-center">
            <i class="fa <?php echo e(session('success') ? 'fa-check-circle' : 'fa-exclamation-triangle'); ?> me-2 fs-5"></i>
            <div>
                <strong><?php echo e(session('success') ? 'Success:' : 'Error:'); ?></strong>
...
<?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>