            ...
            <div class="billing_details">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form id="checkoutForm" class="row contact_form" action="<?php echo e(route('checkout.process')); ?>" method="POST" novalidate="novalidate">
                            <?php echo csrf_field(); ?>

                            <div class="col-md-6 form-group p_star">
                                <input required type="text" class="form-control" id="first" name="name" value="<?php echo e(old('name')); ?>" placeholder="Full name">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 form-group p_star">
                                <input required type="text" class="form-control" id="number" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Phone number">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 form-group p_star">
                                <input required type="email" class="form-control" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email Address">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12 form-group p_star">
                                <input required type="text" class="form-control" id="add1" name="address" value="<?php echo e(old('address')); ?>" placeholder="Address line 01">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12 form-group p_star">
                                <input required type="text" class="form-control" id="city" name="city" value="<?php echo e(old('city')); ?>" placeholder="Town/City">
                    ...
                    <div class="col-lg-4">
                        <div class="order_box">
                            ...
                            <ul class="list">
                                ...
                                <?php if(!empty($cart) && count($cart) > 0): ?>
                                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <li>
                                            <a href="#"><?php echo e($item['name'] ?? 'Product'); ?> <span class="middle">x <?php echo e($qty); ?></span> <span class="last">TZS <?php echo e(number_format($line, 2)); ?></span></a>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                            ...
                            <ul class="list list_2">
                                <li><a href="#">Subtotal <span>TZS <?php echo e(number_format($total, 2)); ?></span></a></li>
                                <li><a href="#">Shipping <span>Flat rate: TZS 2,000</span></a></li>
                                <li><a href="#">Total <span>TZS <?php echo e(number_format($total + 2000, 2)); ?></span></a></li>
                            </ul>
                            <div class="payment_item mt-4">
                                <h4 class="mb-3">Select Payment Method</h4>
                                <div class="mb-2">
                                    <label class="d-flex align-items-center mb-2" for="payment_mpesa" style="cursor:pointer;">
                                        <input type="radio" id="payment_mpesa" name="payment_method" value="M-Pesa" form="checkoutForm" <?php echo e(old('payment_method') === 'M-Pesa' ? 'checked' : ''); ?>>
                                        <span class="ml-2">M-Pesa</span>
                                    </label>
                                </div>
                                <div class="mb-2">
                                    <label class="d-flex align-items-center mb-2" for="payment_crdb" style="cursor:pointer;">
                                        <input type="radio" id="payment_crdb" name="payment_method" value="CRDB BANK" form="checkoutForm" <?php echo e(old('payment_method') === 'CRDB BANK' ? 'checked' : ''); ?>>
                                        <span class="ml-2">CRDB BANK</span>
                                    </label>
                                </div>
                                <div class="mb-2">
                                    <label class="d-flex align-items-center mb-2" for="payment_nmb" style="cursor:pointer;">
                                        <input type="radio" id="payment_nmb" name="payment_method" value="NMB BANK" form="checkoutForm" <?php echo e(old('payment_method') === 'NMB BANK' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
    ...
    $(document).ready(function(){
        ...
        <?php if(session('show_instructions') && session('payment_method')): ?>
            showPaymentInstructions(<?php echo json_encode(session('payment_method'), 15, 512) ?>);
        <?php endif; ?>
    });
    </script>
</body>
...
<?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/checkout.blade.php ENDPATH**/ ?>