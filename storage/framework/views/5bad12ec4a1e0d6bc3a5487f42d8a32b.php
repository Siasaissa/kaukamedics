                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?php echo e($item['quantity']); ?> </span>
                      </td>
                    </tr>
              ...
              <div class="timeline timeline-one-side">
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0"><?php echo e($pendingOrders ?? 0); ?> Pending Orders</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><?php echo e($pendingOrdersPercentage ?? 0); ?>% of total</p>
                  </div>
                </div>
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0"><?php echo e($completedOrders ?? 0); ?> Completed Orders</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0"><?php echo e($completedOrdersPercentage ?? 0); ?>% of total</p>
                  </div>
                </div>
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    ...
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Tsh <?php echo e(number_format($averageOrderValue ?? 0, 0)); ?></p>
                  </div>
                </div>
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0"><?php echo e($totalCustomers ?? 0); ?> Total Customers</h6>
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    ...
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Tsh <?php echo e(number_format($totalRevenue ?? 0, 0)); ?></p>
                  </div>
                </div>
                ...
                <div class="timeline-block">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0"><?php echo e($totalProducts ?? 0); ?> Products</h6>
...
<?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/dashboard.blade.php ENDPATH**/ ?>