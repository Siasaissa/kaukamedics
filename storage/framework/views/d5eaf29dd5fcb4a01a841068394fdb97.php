                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <?php if($product->image): ?>
                          <div class="avatar avatar-sm me-3">
                            <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" class="border-radius-sm" style="width: 60px; height: 60px; object-fit: cover;" onerror="this.onerror=null;this.src='<?php echo e(asset('img/defaultmedical.jpg')); ?>';">
                          </div>
                        <?php else: ?>
                      ...
                      <td class="align-middle text-center">
                        ...
                        <button 
                          ...
                          data-product-image-url="<?php echo e($product->image_url); ?>"
        ...
        <form method="POST" enctype="multipart/form-data" id="editProductForm">
          ...
          <div class="modal-body">
            ...
            <div id="currentImageContainer" class="mb-3 d-none">
              <div class="mt-2">
                <img id="currentProductImage" src="<?php echo e(asset('img/defaultmedical.jpg')); ?>" alt="Current Image" class="img-thumbnail" style="max-width: 100px;">
...
<?php /**PATH /Users/dope/Downloads/public_html-6/resources/views/admin/products/index.blade.php ENDPATH**/ ?>