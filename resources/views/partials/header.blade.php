    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light main_box">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="{{ url('/') }}"><img src="{{ asset('img/fav.png') }}" alt=""></a>
                <div class="d-flex align-items-center d-lg-none">
                    <a href="{{ url('/cart') }}" class="cart mr-3" aria-label="Open cart">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown {{ Request::is('shop*') || Request::is('category*') || Request::is('products*') ? 'active' : '' }}">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Shop</a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="{{ url('/category') }}">Shop Category</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ url('/product') }}">Product Details</a></li>
                        ...
                        <li class="nav-item submenu dropdown {{ Request::is('pages*') ? 'active' : '' }}">
